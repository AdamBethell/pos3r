...
class AsymmetricCroCo3DStereo (
    ...
    def _encode(self, batch):
        ...
        shape1 = batch.get('true_shape', torch.tensor(img1.shape[-2:])[None].repeat(B, 1))
        shape2 = batch.get('true_shape', torch.tensor(img2.shape[-2:])[None].repeat(B, 1))
    ...
    def forward(self, batch):
        ...
        (shape1, shape2), (feat1, feat2), (pos1, pos2) = self._encode(batch)
