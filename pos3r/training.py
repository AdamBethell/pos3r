...
def get_args_parser():
    parser = argparse.ArgumentParser('POS3R training', add_help=False)
    # model and criterion
...
def train_one_epoch(model: torch.nn.Module, criterion: torch.nn.Module,
    ...
    for data_iter_step, batch in enumerate(metric_logger.log_every(data_loader, args.print_freq, header)):
        ...
        loss_tuple = loss_of_one_batch(batch, model, criterion, device, use_amp=bool(args.amp), ret='loss', i=data_iter_step)
